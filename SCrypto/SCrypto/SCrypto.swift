...
public extension Data {
    ...
    /**
     ...
     - returns: Encrypted data.
     */
    func encrypt(_ algorithm: Cipher.Algorithm = .aes, options: Cipher.Options = .PKCS7Padding, key: Data, iv: Data? = nil) throws -> Data {
    ...
    /**
     ...
     - returns: Decrypted data.
     */
    func decrypt(_ algorithm: Cipher.Algorithm = .aes, options: Cipher.Options = .PKCS7Padding, key: Data, iv: Data? = nil) throws -> Data {
        let cipher = Cipher(algorithm: algorithm, options: options, iv: iv?.bytesArray())
